...
export default function PPTToPDF() {
  ...
  const handleConvert = async (files: File[]) => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/api/convert/ppt-to-pdf`, {
        method: 'POST',
        body: formData,
      });
      ...
      toast({
        ...
        description: "PowerPoint presentation converted to PDF",
      });
    } catch (error) {
      toast({
  ...
  return (
    <PDFTool
      ...
      description="Convert PowerPoint presentations to PDF (requires backend service)"
      ...
      uploadLabel="PowerPoint Presentation"
    />
  );
}
